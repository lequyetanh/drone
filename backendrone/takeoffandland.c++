...
std::cout << ERROR_CONSOLE_TEXT << "No autopilot found, exiting." << NORMAL_CONSOLE_TEXT << std::endl;
return 1;
}
...
std::cout << "Altitude: " << alt << " - Latitude: " << lat << " - Longitude: " << lon << std::endl;
...
std::ofstream myfile;
myfile.open("/home/lequyetanh/drone/data/location",std::ios::app);
myfile << alt << ",";
